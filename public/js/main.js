...
(function ($) {
  ...
  jQuery(document).ready(function () {
    ...
    function mobileltn__utilizeMenu() {
      const $ltn__utilizeNav = $('.ltn__utilize-menu, .overlay-menu'),
    ...
    $('.mega-menu').each(function () {
      if ($(this).children('li').length) {
        const ulChildren = $(this).children('li').length;
    ...
    /* ---------------------------------------------------------
            7. Background Image
        --------------------------------------------------------- */
    const $backgroundImage = $('.bg-image, .bg-image-top');
    ...
    /* --------------------------------------------------------
            13. Isotope Gallery Active  ( Gallery / Portfolio )
        -------------------------------------------------------- */
    const $ltnGalleryActive = $('.ltn__gallery-active'),
    ...
    if ($('.ltn__parallax-effect-active').length) {
      const scene = $('.ltn__parallax-effect-active').get(0);
    ...
    /* --------------------------------------------------------
        ...
        -------------------------------------------------------- */
    const ltn__testimonial_quote_slider = $('.ltn__testimonial-slider-4-active');
    ...
    ltn__testimonial_quote_slider.on(
      ...
      function (event, slick, currentSlide, nextSlide) {
        const liIndex = nextSlide + 1;
        const slideImageliIndex = slick.slideCount == liIndex ? liIndex - 1 : liIndex;
        const cart = $(
          '.ltn__testimonial-slider-4 .slick-slide[data-slick-index="' + slideImageliIndex + '"]'
        ).find('.ltn__testimonial-image');
        const imgtodrag = $('.ltn__testimonial-quote-menu li:nth-child(' + liIndex + ')')
          .find('img')
          .eq(0);
        if (imgtodrag) {
    ...
    $(document).on('click', '.ltn__testimonial-quote-menu li', function (e) {
      const el = $(this);
      const elIndex = el.prevAll().length;
      ltn__testimonial_quote_slider.slick('slickGoTo', elIndex);
      const cart = $(
        '.ltn__testimonial-slider-4 .slick-slide[data-slick-index="' + elIndex + '"]'
      ).find('.ltn__testimonial-image');
      const imgtodrag = el.find('img').eq(0);
      if (imgtodrag) {
        AnimateTestimonialImage(imgtodrag, cart);
      }
    });
...
function refresh() {
  $('#divcarrito1').html('');
  const codcodsis = $('#idgenid').val();
  $('#divcarrito1').load('mini-cart1.php?flat=' + codcodsis);
}
